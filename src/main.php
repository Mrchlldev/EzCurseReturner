...
namespace EzMinecraftPlugins\EzCurseReturner;
...
$this->getServer()->broadcastMessage("yes, an ass is where you sh- from. glad you pointed out something everyone has <3");
}
...
$this->getServer()->broadcastMessage("yes, shit is excrement from an animal <3");
}
...
$this->getServer()->broadcastMessage("you wanna fuck knuckles the hedgehog, well i guess you do you, might as well call you mr hands 2.0. <3");
}
